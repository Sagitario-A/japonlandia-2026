...
import { COSTAS as MUNDO } from '../datos/mundo.js?v=c7302cd0';
import { COSTAS as JAPON } from '../datos/japon.js?v=c7302cd0';
import { COSTAS as KANTO } from '../datos/kanto.js?v=c7302cd0';
import { CALLES } from '../datos/calles.js?v=c7302cd0';
import { AUTOPISTAS } from '../datos/autopistas.js?v=c7302cd0';
import { aVectores, envolvente, asomaEnPantalla, trazar, radioActual } from './proyeccion.js?v=c7302cd0';
import { tope, tramo } from './util.js?v=c7302cd0';
