...
import { tramo, suave, tope } from '../motor/util.js?v=a3f6e416';
import { mirarA } from '../motor/proyeccion.js?v=a3f6e416';
import { pintarMapa, pintarRuta, limpiarRutas, pintarVehiculo, marcar, mostrarLienzo, opacidadMapa, alzarLienzo, empequeñecerMapa, limpiarHitos } from '../motor/lienzo.js?v=a3f6e416';
import { tenderRuta } from '../motor/ruta.js?v=a3f6e416';
import { apagarDibujo } from '../motor/dibujo.js?v=a3f6e416';
import { VUELO_IDA, LUGARES } from '../datos/rutas.js?v=a3f6e416';
