...
import { tramo, suave, tope, frena } from '../motor/util.js?v=822ac628';
...
import { mostrarDibujo, colocar, variable, verBanda, desplazarFondo, perfilDe, altura, bajarSuelo, limpiarPiezas, postura, zoomEscena } from '../motor/dibujo.js?v=822ac628';
import { nevar, nieveHastaElSuelo } from '../motor/nieve.js?v=822ac628';
import { tenderRuta } from '../motor/ruta.js?v=822ac628';
import { LUGARES, RUTA_NORTE, ENCUADRES } from '../datos/rutas.js?v=822ac628';
