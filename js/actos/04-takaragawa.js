...
import { tramo, suave, tope, frena } from '../motor/util.js?v=0191c20d';
...
import { mostrarDibujo, colocar, variable, verBanda, desplazarFondo, perfilDe, altura, bajarSuelo, limpiarPiezas, postura, zoomEscena } from '../motor/dibujo.js?v=0191c20d';
import { nevar, nieveHastaElSuelo } from '../motor/nieve.js?v=0191c20d';
import { tenderRuta } from '../motor/ruta.js?v=0191c20d';
import { LUGARES, RUTA_NORTE, ENCUADRES } from '../datos/rutas.js?v=0191c20d';
